export class ModuleGroupFromDatabase {
  constructor(name: string, obligateModuleClasses: string[], moduleClasses: string[], subGroups: string[], minimumCredits: number, obligateGroup: boolean) {
    this._name = name;
  ...
  private _subGroups: string[];

  get subGroups(): string[] {
    return this._subGroups;
  }

  set subGroups(value: string[]) {
